      ...
      if (isDiamond) {
        ...
        if (IS_MOBILE) {
          ...
          const mat = new THREE.MeshPhysicalMaterial({
            color: gemTint, metalness: 0.0, roughness: 0.02, transmission: 1.0, thickness: 0.55, ior: 2.33,
            attenuationColor: new THREE.Color(0xffffff), attenuationDistance: 1.5, envMap: this.envRaw,
            envMapIntensity: 1.8, specularIntensity: 1.0, specularColor: new THREE.Color(0xffffff),
            clearcoat: 1.0, clearcoatRoughness: 0.03, iridescence: 0.65, iridescenceIOR: 1.45, iridescenceThicknessRange: [120, 480]
          });
          obj.material = mat;
