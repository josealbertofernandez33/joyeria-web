...
// =========================================================
// CORRECCIÓN FINAL: ENVÍO MÚLTIPLE DE ARCHIVOS
// =========================================================
...
form.addEventListener('submit', async function(e) {
    ...
    // 1. Limpiamos cualquier rastro anterior de 'attachment' simple
    formData.delete('attachment');
    formData.delete('attachment[]'); // Por seguridad borramos ambos antes de rellenar

    // 2. Insertamos TODOS los archivos con el nombre 'attachment[]'
    // Esto es lo que le dice al servidor "soy una lista de archivos"
    for (let i = 0; i < dt.files.length; i++) {
